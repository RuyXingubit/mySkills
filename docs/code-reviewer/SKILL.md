...
- [Review Checklist](file:///Users/ruy/Code/mySkills/docs/code-reviewer/references/code_review_checklist.md): Step-by-step review process.
- [Coding Standards](file:///Users/ruy/Code/mySkills/docs/code-reviewer/references/coding_standards.md): Language-specific best practices.
- [Common Anti-patterns](file:///Users/ruy/Code/mySkills/docs/code-reviewer/references/common_antipatterns.md): What to avoid during development.
