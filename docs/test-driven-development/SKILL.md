...
- **Anti-patterns**: Avoid common testing mistakes documented in [Testing Anti-patterns](file:///Users/ruy/Code/mySkills/docs/test-driven-development/testing-anti-patterns.md).
