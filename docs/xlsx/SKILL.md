...
- **Recalculation**: Use the `docs/xlsx/scripts/recalc.py` tool to verify and update values after modification.
...
## Tools
- **Recalc Script**: `docs/xlsx/scripts/recalc.py` (requires LibreOffice for headless recalculation).
