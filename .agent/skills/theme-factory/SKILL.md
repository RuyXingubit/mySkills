...
## Workflow
1. **Showcase**: Reference `.agent/skills/theme-factory/theme-showcase.pdf` to visualize all themes.
...
## Technical Assets
- **Theme Specs**: Individual `.md` files in `.agent/skills/theme-factory/themes/`.
- **Visual Grid**: `.agent/skills/theme-factory/theme-showcase.pdf`.
